     ...
     $.fn.formset = function(opts) {
         ...
         const addInlineAddButton = function() {
             if (addButton === null) {
                 if ($this.prop("tagName") === "TR") {
                     ...
                     $parent.append('<tr class="' + options.addCssClass + '"><td colspan="' + numCols + '"><a class="btn btn-muted" href="#">' + options.addText + "</a></tr>");
                     addButton = $parent.find("tr:last a");
                 } else {
                     // Otherwise, insert it immediately after the last form:
                     $this.filter(":last").after('<div class="' + options.addCssClass + '"><a class="btn btn-muted" href="#">' + options.addText + "</a></div>");
         ...
         const addInlineDeleteButton = function(row) {
             if (row.is("tr")) {
                 ...
                 row.children(":last").append('<div><a class="btn btn-danger ' + options.deleteCssClass + '" href="#">' + options.deleteText + "</a></div>");
             } else if (row.is("ul") || row.is("ol")) {
                 // If they're laid out as an ordered/unordered list,
                 // insert an <li> after the last list item:
                 row.append('<li><a class="btn btn-danger ' + options.deleteCssClass + '" href="#">' + options.deleteText + "</a></li>");
             } else {
                 // Otherwise, just insert the remove button as the
                 // last child element of the form's container:
                 row.children(":first").append('<span><a class="btn btn-danger ' + options.deleteCssClass + '" href="#">' + options.deleteText + "</a></span>");
             }
